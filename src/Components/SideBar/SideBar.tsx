...
// Define the expected structure of userData based on what is used in the component
interface User {
  firstName: string;
  lastName: string;
  image: string;
...
// Define the structure of the AuthContext to match the AuthContextProvider
    ...
    <div className="sidebarContainer vh-100">
      <Sidebar collapsed={isCollapsed} className="vh-100">
        <div className="text-center my-5">
          <div>
            {isCollapsed ? (
              <FaArrowCircleRight onClick={toggleCollapse} size={30} className="my-2" />
            ) : (
        ...
        <Menu>
          ...
          <MenuItem icon={<FaUsersLine size={25} />} component={<Link to="/dashboard/users-list" />}>
            Users
          </MenuItem>
          <MenuItem icon={<FaUserShield size={25} />} component={<Link to="/dashboard/user-data" />}>
            Add user
          </MenuItem>
          <MenuItem icon={<CgProfile size={25} />} component={<Link to="/dashboard/profile" />}>
            Profile
          </MenuItem>
